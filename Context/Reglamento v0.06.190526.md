# EKKO - Reglamento Oficial
**Versión 0.06.190526**
*Última actualización: 19 de Mayo, 2026*

Este documento contiene las reglas base y la estructura del sistema de juego de cartas coleccionables **EKKO** para dispositivos móviles.

El juego es simple: para ganar alcanza con dejar los puntos de vida de tu oponente en 0, pero ojo, que si te quedas sin la posibilidad de robar cartas del mazo también puedes perder.
